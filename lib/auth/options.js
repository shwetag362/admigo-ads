...
export const authOptions = {
  providers: [
    ...
    FacebookProvider({
      ...
      authorization: {
        params: {
          // NOTE: 'email' and 'instagram_basic' removed — they showed as
          // "Invalid Scopes" until enabled in the Facebook app (email needs the
          // Facebook Login product + permission added; instagram_basic needs the
          // Instagram product + App Review). Re-add them once enabled on FB side.
          scope: [
            'public_profile',
            'ads_management',
            'ads_read',

...
//       new CustomEvent("adsManagerTabChange", { detail: activeTab })
//     );
//   }, [activeTab]);
...
export default function AdsManagerPage() {
  ...
  const tableProps = useMemo(() => {
    const baseProps = {
      selectedAdAccountId,
      syncData,
      dateRange,  // Pass array as before
      datePreset, // ADD THIS
    };
    ...
    return baseProps;
  }, [activeTab, selectedAdAccountId, syncData, dateRange, datePreset, selectedCampaignId, selectedAdSetId, handleCampaignSelect, handleAdSetSelect])
  ...
  return (
    <div className="px-2 py-4">
      <Tabs
        ...
        onAdAccountChange={(id) => setSelectedAdAccountId(id)}

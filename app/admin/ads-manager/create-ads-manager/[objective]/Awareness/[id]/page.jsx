...
export { default } from "@/app/dashboard/ads-manager/create-ads-manager/[objective]/Awareness/[id]/page";
export * from "@/app/dashboard/ads-manager/create-ads-manager/[objective]/Awareness/[id]/page";

...
export { default } from "@/app/dashboard/ads-manager/create-ads-manager/[objective]/page";
export * from "@/app/dashboard/ads-manager/create-ads-manager/[objective]/page";

...
export { default } from "@/app/dashboard/ads-manager/create-ads-manager/[objective]/Sales/[id]/page";
export * from "@/app/dashboard/ads-manager/create-ads-manager/[objective]/Sales/[id]/page";

...
export { default } from "@/app/dashboard/ads-manager/create-ads-manager/[objective]/Traffic/[id]/page";
export * from "@/app/dashboard/ads-manager/create-ads-manager/[objective]/Traffic/[id]/page";

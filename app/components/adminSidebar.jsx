...
const NAV_ITEMS = [
  { name: "Overview", url: "/admin/overview", icon: House },
  {
    name: "Ads Manager", url: "/admin/ads-manager", icon: FaAd,
    children: [
      { name: "All Campaigns", url: "/admin/ads-manager",  icon: Layers },
      { name: "Facebook Pages",     url: "/admin/facebook-pages",     icon: Zap },
      { name: "Creative Media",     url: "/admin/creative-media",     icon: MonitorPlay },
    ],
  },
  {
    name: "Ads Reporting", url: "/admin/ads-reporting", icon: BarChart3,
    children: [
      { name: "Performance",    url: "/admin/ads-reporting/performance", icon: TrendingUp },
      { name: "Analytics",      url: "/admin/ads-reporting/analytics",   icon: PieChart },
    ],
  },
  {
    name: "Events Manager", url: "/admin/events-manager", icon: Database,
    children: [
      { name: "Overview",        url: "/admin/events-manager/overview",        icon: LayoutDashboard },
      { name: "Data Sources",    url: "/admin/events-manager/datasources",     icon: DatabaseZap },
      { name: "Pixel Setup",     url: "/admin/events-manager/pixels",          icon: Crosshair },
      { name: "Conversions API", url: "/admin/events-manager/conversions-api", icon: RefreshCw },
    ],
  },
  { name: "Orders Manager", url: "/admin/orders-manager", icon: ClipboardList },
  { name: "Ad Monitor",     url: "/admin/ad-monitor",     icon: Monitor },
  {
    name: "Account Manager", url: "/admin/account-manager", icon: UserCog,
    children: [
      { name: "Ad Accounts",   url: "/admin/account-manager/ad-accounts",  icon: FaAd },
    ],
  },
    {
    name: "Team", url: "/admin/team", icon: Users,
    children: [
      { name: "Members",    url: "/admin/team",         icon: Users },
      { name: "Invites",    url: "/admin/team/invites", icon: UserPlus },
    ],
  },
  {
    name: "Settings", url: "/admin/accounts", icon: Settings,
    children: [
      { name: "Connect Facebook", url: "/admin/settings/add-f-accounts", icon: ArrowLeftRight },
    ],
  },
];
